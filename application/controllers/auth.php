	...
	function profile()
  {
    ...
    if ($this->input->post('username') != $user->username) {
      ...
      $users_table = $tables['users'];
		  $this->form_validation->set_rules('username', $this->lang->line('edit_user_validation_username_label'), "trim|is_unique[$users_table.username]|required|xss_clean");
    }
    ...
    if ($this->input->post('email') != $user->email) {
      ...
      $users_table = $tables['users'];
		  $this->form_validation->set_rules('email', $this->lang->line('edit_user_validation_email_label'), "trim|is_unique[$users_table.email]|required|xss_clean");
    }
